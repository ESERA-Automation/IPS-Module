<?php
class EseraTemperaturHelligkeitPV extends IPSModule {
    ...
    public function Create(){
        ...
        $this->CreateVariableProfile("ESERA.PV", 2, " w/m²", 10, 70000, 0, 2, "Sun");
        ...
        $this->RegisterVariableFloat("Einstrahlung", "Einstrahlung", "ESERA.PV", 4);
    ...
    public function ApplyChanges(){
        ...
        if (!@$this->GetIDForIdent("Einstrahlung")) $this->RegisterVariableFloat("Einstrahlung", "Einstrahlung", "ESERA.PV", 4);
    ...
    public function ReceiveData($JSONString) {
        ...
        $this->SendDebug("ESERA-Temperatur-Helligkeit-PV", "DataPoint:" . $data->DataPoint . " | Value: " . $data->Value, 0);
        ...
        if ($this->ReadPropertyInteger("OWDID") == $data->DeviceNumber) {
            ...
            if ($data->DataPoint == 4) {
                $value = $data->Value / 100;
                SetValue($this->GetIDForIdent("Einstrahlung"), $value);
            }
        }
    }
